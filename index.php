		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>X-FORCE CHECKER RATE LIMIT BYPASS CHECKER</strong></h4>
...
<footer>
  <p>CODE By <a href="https://t.me/xforce_carding">@GovermentOfAmerica</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "X-FORCE CHECKER CHECKER", 
  text: "JOIN THIS CHANNEL TO USE THE CHECKER!",
  icon: 'warning',
...
function RedirectUrl(){    
       window.location.href ="https://t.me/xforce_carding";
    }
